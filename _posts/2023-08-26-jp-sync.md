...
1. JSON5 is not an official standard (unlike JSON) and so may be subject to changes
...
**YAML** is easier to read for humans than JSON or JSON5, but I feel it's still limited in this regards for more complex configuration files:
